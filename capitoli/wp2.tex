...
% Obiettivo della sezione: presentare l'idea generale del protocollo prima dei
% dettagli tecnici.
%
% TODO: Introdurre l'architettura client-server crittografica articolata in cinque
% fasi: setup, autenticazione, costruzione della scheda, conservazione e scrutinio.
%
% TODO: Spiegare la separazione funzionale tra Sistema di Autenticazione (SA) e
% Autorità Elettorale (AE): il SA conosce le identità, l'AE gestisce schede cifrate
% e pseudonimi, ma non deve conoscere l'identità reale degli elettori.
%
% TODO: Richiamare l'Assunzione 1 del WP1: non-collusione SA/AE. Specificare che
% lo pseudo-anonimato realizzato dal protocollo è condizionato a tale assunzione.
%
% TODO: Anticipare i due limiti strutturali che resteranno anche nel WP2:
% (i) segretezza delle singole schede rispetto all'AE durante lo scrutinio
%     (cfr. Sezione~\ref{subsec:wp2_limite_sec1});
% (ii) verificabilità universale piena del conteggio
%     (cfr. Sezione~\ref{subsec:wp2_limite_ver2}).
% Il WP3 analizzerà il rischio residuo associato a questi limiti.
