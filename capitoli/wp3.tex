...
L'architettura separa nettamente le funzioni (il SA conosce le identità reali ma non vede i voti; l'AE vede i voti ma riceve solo certificati pseudonimi $C_p$). Tuttavia, se i gestori dei due server decidessero di cooperare in modo disonesto, l'anonimato decadrebbe istantaneamente. Al SA basterebbe fornire all'AE il registro delle associazioni temporali o dei metadati di rete (es. indirizzi IP) per consentire l'incrocio dei dati e identificare l'autore di ogni singola scheda cifrata.
