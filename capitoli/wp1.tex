...
\begin{figure}[H]
    ...
    AE Disonesta       & & & & & $\bullet$ & & & & & $\triangle$ & $\bullet$ & $\bullet$ \\
    \hline
    \end{tabular}
    \endgroup
    \vspace{4pt}
    ...
    \caption{Matrice di copertura minacce--proprietà. La riga dell'Attaccante DoS è interamente vuota: nessuna micro-proprietà affronta la minaccia alla disponibilità del servizio.}
