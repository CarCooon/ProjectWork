...
\begin{titlepage}
    \begin{center}
        ...
        \normalsize{Corso: \\ALGORITMI E PROTOCOLLI PER LA SICUREZZA}\\[20mm]
        \includegraphics[width=0.35\textwidth]{immagini/logo_unisa}\\[20mm]
        \textbf{\large PROJECT WORK}\\[15mm]
    \end{center}

    \begin{center}
        \Large{\textbf{Carmine Terracciano}}
        \quad
        \large{Mat. IE22700109}\\[5mm]
        \Large{\textbf{Ferdinando Paparo}}
        \quad
        \large{Mat. IE22700107}\\[10mm]
    \end{center}
